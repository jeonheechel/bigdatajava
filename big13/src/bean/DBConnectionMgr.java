...
public class DBConnectionMgr {
    private Vector connections = new Vector(10000);//커넥션 리스트를 만들어주는 코드다
    private String _driver = "com.mysql.jdbc.Driver",
    _url = "jdbc:mysql://localhost:3306/bigdata",
    _user = "root",
    _password = "1234";
    ...
    public synchronized Connection getConnection()//받아서 사용만 하면 된다
            throws Exception {
        if (!initialized) {
